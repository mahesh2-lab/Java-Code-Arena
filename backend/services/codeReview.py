...
_SYSTEM_PROMPT = (
    ...
    "IMPORTANT: Output plain text ONLY. DO NOT use any Markdown formatting like **bold**, `code`, or ```code blocks```. Use ALL CAPS for emphasis if needed."
)
...
def ai_review_error(error_text, source_code="", is_compilation_error=False):
    ...
    try:
        ...
        if content and content.strip():
            # Remove Markdown formatting so it prints cleanly in raw terminal output
