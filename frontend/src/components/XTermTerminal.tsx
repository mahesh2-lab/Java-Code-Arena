    ...
    ({ theme, onStatusChange, onSidReady }, ref) => {
        ...
        useEffect(() => {
            ...
            socket.on("terminal:exit", (data: { code: number; reason: string }) => {
                ...
                if (data.reason === "killed") {
                    ...
                    term.writeln("\r\n\x1b[2m─────────────────────────────────────\x1b[0m");
                    term.writeln(`\x1b[31m✗ Program exited with code ${data.code}\x1b[0m`);
                }
                setStatus("exited");
            });
        ...
        useEffect(() => {
            ...
            const disposable = term.onData((data) => {
                if (statusRef.current !== "running" || !socketRef.current?.connected) return;
        ...
        useImperativeHandle(
            ...
            () => ({
                ...
                clear() {
                    ...
                    termRef.current?.writeln("\x1b[36m╔══════════════════════════════════════╗\x1b[0m");
                    termRef.current?.writeln("\x1b[36m║  \x1b[1;32mJavaRena Interactive Terminal\x1b[0m\x1b[36m       ║\x1b[0m");
                    termRef.current?.writeln("\x1b[36m╚══════════════════════════════════════╝\x1b[0m");
                    termRef.current?.writeln("");
                    setStatus("idle");
                },
            ...
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        backgroundColor: theme === "dark" ? "rgba(13, 17, 23, 0.4)" : "rgba(255, 255, 255, 0.05)",
